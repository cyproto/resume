...
\begin{textblock*}{14cm}(6.5cm,25.60cm)
   \textcolor{black}{\fontsize{15}{20}\selectfont  {2] Familiar with Django, Angular, Flutter, React-Native.}}
\end{textblock*}
\begin{textblock*}{14cm}(6.5cm,26.50cm)
   \textcolor{black}{\fontsize{15}{20}\selectfont {3] Good knowledge of MySQL and Oracle DBMS.}}
\end{textblock*}
\newpage
\begin{tikzpicture}
...
\end{tikzpicture}
\begin{textblock*}{3.6cm}(1cm,2.70cm)
   \begin{mdframed}[style=Frame1]
   \textcolor{white}{\fontsize{20}{20}\selectfont Hobbies/\\Interests}
   \end{mdframed}
\end{textblock*}
\begin{textblock*}{14cm}(6.5cm,2.00cm)
\textcolor{black}{\fontsize{15}{20}\selectfont  {1] Maintaining and building custom roms and kernels for android devices. Porting android roms.} \vspace{5mm}}
\end{textblock*}
\begin{textblock*}{14cm}(6.5cm,3.25cm)
   \textcolor{black}{\fontsize{15}{20}\selectfont {2] Making UI/UX designs on Adobe XD.}}
\end{textblock*}
\begin{textblock*}{14cm}(6.5cm,4.05cm)
...
\end{textblock*}
\begin{textblock*}{14cm}(6.5cm,5.25cm)
